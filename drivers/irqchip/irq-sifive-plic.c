				   ...
				   struct irq_data *d, int enable)
{
	...
	struct plic_priv *priv = irq_data_get_irq_chip_data(d);
        ...
        pr_info("Prio location: 0x%lx, enable: 0x%lx", priv->regs + PRIORITY_BASE + d->hwirq * PRIORITY_PER_ID, enable);
		...
		struct device_node *parent)
{
	...
	/* Test mapping */
	//pr_info("****--------test mapping 111-----****** 0x%lx", priv->regs + CONTEXT_BASE + 1 * CONTEXT_PER_HART);
	...
	////writel(0xffffffd000201004, 0x1011);
	//pr_info("*******---------test end-------*****");
	//pr_info("*******---------test end-------*****");
	//pr_info("*******---------test end-------*****");
	//pr_info("*******---------test end-------*****");
